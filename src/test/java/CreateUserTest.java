...
public class CreateUserTest {
    ...
    @Description("Создать уже зарегистрированного пользователя")
    ...
    @Description("Создать пользователя не заполняя обязательное поле email")
    ...
    @Description("Создать пользователя не заполняя обязательное поле password")
    ...
    @Description("Создать пользователя не заполняя обязательное поле name")
